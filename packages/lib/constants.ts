...
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Artio Carbon Limited";
...
export const FAVICON_16 = "/artio-logo-gold.png";
export const FAVICON_32 = "/artio-logo-gold.png";
export const APPLE_TOUCH_ICON = "/artio-logo.png";
export const MSTILE_ICON = "/artio-logo.png";
export const ANDROID_CHROME_ICON_192 = "/artio-logo.png";
export const ANDROID_CHROME_ICON_256 = "/artio-logo.png";
