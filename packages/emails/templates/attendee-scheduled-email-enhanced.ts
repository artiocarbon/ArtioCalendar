...
export default class AttendeeScheduledEmailEnhanced extends BaseEmail {
  ...
  constructor(calEvent: CalendarEvent, attendee: Person, showAttendees?: boolean | undefined) {
    ...
    this.name = "SEND_BOOKING_CONFIRMATION_ENHANCED";
  ...
  async getHtml(calEvent: CalendarEvent, attendee: Person) {
    return await renderEmail("AttendeeScheduledEmailEnhanced", {
      calEvent,
      attendee,
    });
  }
